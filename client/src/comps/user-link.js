...
// A component for displaying a user profile link with a popover.
export default ({ user, ...props }) => {
    // A dirty hack to force showing of popover when popover itself is hovered
    let [show, setShow] = React.useState(undefined)

    // If 'to' prop is not provided, set it to the user's profile URL.
...
// A Popover component for displaying user information.
